...
if __name__ == '__main__':
    ...
    # we want to specify the data we teach the machin
    # this is examples of features which may be good for prediction
    ...
    X_lately = X[-forcast_out:] # in the example is 1 precent of the last data
    # x_lately is the stuff we will use to predict again - currently we don't have this values
    X = X[:-forcast_out] # in this example: forcast_out = int(math.ceil( 0.01 * len(df))), is 99% of the data
    ...
    # -------------------------------------------------------------------
    # How to train your classifier without saving it into memroy
    # -------------------------------------------------------------------
    ...
    # # dumps the classifier
    # with open('linearregression.pickle', 'wb') as f:
    #     pickle.dump(clf, f)

    #-------------------------------------------------------------------
    # Pickle is using to save the data you learn the machine into a file
    # this is a type of file for the machine
    # it use to save file of the classifier's training
    #-------------------------------------------------------------------

    pickle_in = open(('linearregression.picle' , 'rb')) # open the pickle which save in this directory
    clf = pickle.load(pickle_in) # redefine the classifier
